...
const categoryColors: Record<
  ToolCategory,
  { bg: string; text: string; hover: string; iconBg: string }
> = {
  Edit: {
...
export default function Layout({
  ...
  return (
    <div
      className={`min-h-screen flex flex-col bg-[#FAFAFA] dark:bg-black text-gray-900 dark:text-zinc-100 transition-colors duration-300`}
    >
      {isDragging && (
        <div className="fixed inset-0 z-[200] bg-rose-500/10 backdrop-blur-sm flex items-center justify-center pointer-events-none">
          <div className="bg-white dark:bg-zinc-900 p-12 rounded-[3rem] shadow-2xl border-4 border-dashed border-rose-500 animate-in zoom-in duration-300">
            ...
            <p className="mt-4 font-black uppercase tracking-widest text-rose-500 text-center text-sm">
              Drop PDF to start
            </p>
          </div>
        </div>
        ...
        <header className="flex items-center justify-between px-4 md:px-8 h-16 md:h-20 border-b border-gray-100 dark:border-zinc-800 bg-white/80 dark:bg-zinc-950/80 backdrop-blur-md sticky top-0 z-[100]">
          <div className="flex items-center gap-2 md:gap-4 flex-1 min-w-0">
            {!isHome && (
              <button
                onClick={() => navigate("/")}
                className="p-2 hover:bg-gray-100 dark:hover:bg-zinc-900 rounded-xl transition-colors text-gray-500 hover:text-rose-500 shrink-0"
              >
            ...
            >
              <PaperKnifeLogo
                size={Capacitor.isNativePlatform() ? 24 : 28}
                iconColor="#F43F5E"
              />
              <span className="font-black tracking-tighter text-lg md:text-xl dark:text-white hidden xs:block">
                PaperKnife
              </span>
            </Link>
            ...
            <div className="relative min-w-0" ref={dropdownRef}>
              <button
                ...
                className={`flex items-center gap-2 px-2 md:px-3 py-1.5 rounded-xl transition-all font-black text-[10px] md:text-sm uppercase tracking-widest min-w-0 ${isDropdownOpen ? "bg-rose-500 text-white" : "text-gray-500 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-zinc-900"}`}
              >
                    ...
                    return (
                      <div key={category} className="mb-4">
                        <div className="px-6 py-2">
                          <span
                            className={`text-[10px] font-black uppercase tracking-[0.2em] ${colors.text} opacity-60`}
                          >
                            {category}
                          </span>
                        </div>
                        <div className="grid grid-cols-1 gap-1 px-2">
                          {categoryTools.map((tool, i) => {
                            ...
                            const isActive =
                              activeTool?.title === tool.title && !isHome;
                            return (
                              <button
                                key={i}
                                onClick={() => {
                              ...
                              >
                                <div
                                  className={`p-2 rounded-lg transition-colors ${isActive ? "bg-white dark:bg-zinc-800" : `${colors.iconBg} ${colors.text} opacity-70 group-hover:opacity-100`}`}
                                >
                                  <Icon size={18} />
                                </div>
          ...
          <div className="flex items-center gap-1 md:gap-3 shrink-0">
            ...
            <Link
              to="/about"
              className={`p-2 md:px-4 md:py-2 rounded-xl text-[10px] md:text-xs font-black uppercase tracking-widest transition-all flex items-center gap-2 ${location.pathname.includes("about") ? "bg-rose-50 dark:bg-rose-900/20 text-rose-500" : "text-gray-500 hover:bg-gray-100 dark:hover:bg-zinc-900"}`}
            >
              <InfoIcon size={18} />
          ...
          <div className="max-w-7xl mx-auto px-6 md:px-8 py-10 md:py-12">
            <div className="grid grid-cols-2 md:grid-cols-12 gap-8 mb-12">
              ...
              <div className="col-span-2 md:col-span-6 space-y-4">
                <Link
                  to="/"
                  className="flex items-center gap-2.5 text-gray-900 dark:text-white group w-fit"
                >
                  <PaperKnifeLogo
                    size={22}
                    iconColor="#F43F5E"
                  ...
                  />
                  <span className="font-bold tracking-tight text-lg group-hover:text-rose-500 transition-colors">
                    PaperKnife
                  </span>
                </Link>
                ...
                <div className="flex items-center gap-2 pt-1">
                  ...
                  <a
                    ...
                    target="_blank"
                    className="p-2 bg-gray-50 dark:bg-zinc-900 rounded-xl hover:bg-rose-500 hover:text-white transition-all text-gray-500 dark:text-zinc-500"
                  >
                    <GHIcon size={14} />
                  </a>
                </div>
              ...
              <div className="col-span-1 md:col-span-3">
                <h4 className="font-bold text-[10px] uppercase tracking-widest text-gray-900 dark:text-white mb-4">
                  Protocol
                </h4>
                <ul className="space-y-2.5 text-xs text-gray-500 dark:text-zinc-500">
                  ...
                  <li>
                    <a
                      href="https://github.com/potatameister/PaperKnife/blob/main/LICENSE"
                      target="_blank"
                      className="hover:text-rose-500 transition-colors"
                    >
                      License
              ...
              <div className="col-span-1 md:col-span-3">
                ...
                <ul className="space-y-2.5 text-xs text-gray-500 dark:text-zinc-500">
                  <li>
                    ...
                    >
                      Sponsor <HeartIcon size={10} className="text-rose-500" />
                    </a>
                  </li>
                  <li>
                    <a
                      href="https://github.com/potatameister/PaperKnife/issues"
                      target="_blank"
                      className="hover:text-rose-500 transition-colors"
                    >
                      Report Bug
            ...
            <div className="pt-6 border-t border-gray-100 dark:border-white/5 flex flex-col md:flex-row justify-between items-center gap-4 text-[11px] text-gray-400 dark:text-zinc-600 font-medium">
              ...
              <div className="flex gap-6 items-center">
                <a
                  href="https://github.com/potatameister"
                  target="_blank"
      ...
      {shouldShowNav && (
        <nav className="fixed bottom-0 left-0 right-0 bg-white dark:bg-black border-t border-gray-100 dark:border-zinc-800 flex items-end justify-between px-6 pb-[calc(env(safe-area-inset-bottom)+16px)] pt-3 z-[100] shadow-[0_-4px_20px_rgba(0,0,0,0.03)]">
          ...
          >
            <LayoutGridIcon
              size={24}
              strokeWidth={location.pathname === "/android-tools" ? 2.5 : 2}
            />
          ...
          >
            <HistoryIcon
              size={24}
              strokeWidth={location.pathname === "/android-history" ? 2.5 : 2}
            />
      ...
      <aside
        className={`fixed top-0 right-0 h-screen w-full sm:w-80 bg-white dark:bg-zinc-950 border-l border-gray-100 dark:border-zinc-800 z-[150] shadow-2xl transition-transform duration-500 ease-out transform ${showHistory ? "translate-x-0" : "translate-x-full"}`}
      >
          ...
          <div className="flex-1 overflow-y-auto space-y-3 scrollbar-hide">
            {activity.length === 0 ? (
              <div className="text-center py-20 opacity-40">
                <p className="text-xs font-bold uppercase tracking_widest text-gray-400">
                  No recent files
                </p>
              </div>
            ) : (
              activity.map((item) => (
                <div
                  key={item.id}
                  className="p-4 bg-gray-50 dark:bg-zinc-900/50 rounded-2xl border border-gray-100 dark:border-zinc-800 group relative"
                >
